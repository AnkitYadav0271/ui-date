...
- **Guaranteed Unit Safety** _ formattedUnit uses multi-layer token extraction to guarantee a clean, localized unit label across all locales and browsers even in complex CJK or RTL languages without requiring manual regex splitting.
